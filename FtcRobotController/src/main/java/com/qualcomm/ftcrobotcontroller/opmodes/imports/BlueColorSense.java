...
public class BlueColorSense extends PacmanBotHardwareBase {
    ...
    public void loop(){
        ...
        else if (timer.time() < 1.70) {
            drive(0,1); //1.4
        }
        else if (timer.time() < 5.05) {
            drive(1,0); //3.75, 3.5
        }
        else if (timer.time() < 5.6) {
            drive(0,1); //4.0, 3.75
        }
        else if (timer.time() < 6.6) {//5.4
            drive(0.5,0); //5.2, 5.4
        }
        else {
            drive(0,0);
